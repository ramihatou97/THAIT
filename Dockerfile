...
# Create app user
RUN useradd -m -u 1000 neuroscribe && \
    mkdir -p /app && \
    chown -R neuroscribe:neuroscribe /app
...
# Download spaCy and scispaCy models
...
COPY --chown=neuroscribe:neuroscribe . /app
